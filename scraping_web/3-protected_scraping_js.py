...
# les problemes liees a Javascript : le site s'affiche correctement sur le navigateur mais le script n'arrive pas a le scraper.
# Headless Browsing : contourner les problemes liées au JavaScript(Selenium Web)
# Le script pilote un navigateur qui lui va faire appel au serveur

# Solutions de scraping profesionnel(bright data, )
# - Réseau de proxys
# - Captchas
# - Protections / évolutions
# - Headless browser
# - API (SERP)
